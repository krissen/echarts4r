...
The wordcloud also supports a rectangle shape that uses horizontal orientation and fills the available width:
...
tf |> 
  ...
  e_title("Rectangle Wordcloud", "Horizontal layout")
```
